...
import { Utensils, PlusCircle, Edit, Trash2, XCircle, Upload, CheckCircle2, AlertCircle, Clock, Flame } from 'lucide-react';
...
import { BulkDishImporter } from '../components/bulk-dish-importer';
...
export function DishesSection() {
    ...
    if (isLoadingDishes || isLoadingContributions || isLoadingMissing) {
        return (
                        ...
                        <CardContent>
                            <Tabs defaultValue="unverified" className="w-full">
                                <TabsList className="mb-4 bg-muted/30 p-1 h-auto">
                                    <TabsTrigger value="unverified" className="py-2 px-4 rounded-none">
                                    ...
                                    <TabsTrigger value="verified" className="py-2 px-4 rounded-none">
