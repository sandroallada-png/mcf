    ...
    return (
        <div className="h-screen w-full bg-background font-body select-none">
            ...
            <Dialog open={planOpen} onOpenChange={setPlanOpen}>
                <DialogContent className="max-w-3xl w-full rounded-2xl border-none p-0 overflow-hidden shadow-2xl bg-background">
                    ...
                    {/* Footer */}
                    <div className="p-4 border-t border-border/30 bg-background flex items-center justify-between gap-4">
                        <p className="text-xs text-muted-foreground font-medium">
                            <span className="font-black text-foreground">{enabledCount}</span> / {planEntries.length} repas sélectionnés
                        </p>
                        <div className="flex gap-2">
                            <Button variant="outline" className="rounded-xl h-10 text-xs font-bold" onClick={() => setPlanOpen(false)}>
                                Annuler
                            </Button>
                            <Button
                                className="rounded-xl h-10 font-black text-xs uppercase tracking-wider px-6"
                            ...
                            >
                                ...
                                {isPlanning ? 'Planification...' : `Planifier ${enabledCount} repas`}
                            </Button>
                        </div>
                    </div>
                </DialogContent>
